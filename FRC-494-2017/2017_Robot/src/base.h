...
extern float a6_StrafeTime;
extern float a5_StrafeTime;
extern float a3_StrafeTime;
extern float a4_StrafeTime;
extern float a2_StrafeTime;
extern float a1_StrafeTime;
...
extern float ShooterRPM1;
extern float ToolBarAmps;
extern float AtonFinalRotate;
extern float a6_ShotDist;
extern float a5_ShotDist;
extern float a4_ShotDist;
extern float a3_ShotDist;
extern float a2_ShotDist;
extern float a1_ShotDist;
...
extern  float  elevRes   ;
extern	float  elevOff   ;
extern	float  armOff    ;
extern	float  feederRes ;
extern	float  toroBlockAfterShotTime ;

extern	float  elevGain   ;
extern	float  feederGain ;
...
extern  float ballDetect1     ;
extern  float ballDetect2     ;
extern  float ballDetect3     ;
extern  float ballDetect4     ;
extern  float armFlag         ;
extern  float elevFlag        ;
extern  float elevSpeed       ;
...
extern  float RS_ShotAngBeg;
extern  float RS_ShotAngEnd;

extern  float armState;
extern  float armRate;
 ...
 extern float RS_ShotSpeed    ;
 extern float shooterState ;
...
// extern int    steeringTimeOut;
 ...
 extern float autoDriveR;
  ...
  extern float butterflyLocation;
 ...
 // 2014 Shooter
  ...
  extern  float ballLoadLoc;
  extern  float ballLoadRate;
  extern  float fShotAngle1;
  extern  float fShotRate1;

  extern  float fShotAngle2  ;
  extern  float fShotRate2  ;
  extern  float sShotAngle1  ;
  extern  float sShotRate1  ;

  extern  float sShotAngle2;
  extern  float sShotRate2;
  extern  float shooterMidDuration;
  extern  float shooterTopDuration;

  extern  float shooterDownDuration;
  extern  float shooterDownRate;
  extern  float shooterEndDuration;
  extern  float shooterEndRate;
...
extern double lastClock;
 ...
 extern float a1_Dist  ;
 extern float a2_Dist  ;
 extern float a3_Dist  ;
 extern float a4_Dist  ;
 extern float a5_Dist  ;
 extern float a6_Dist  ;
 extern float a1_Speed ;
 extern float a2_Speed ;
 extern float a3_Speed ;
 extern float a4_Speed ;
 extern float a5_Speed ;
 extern float a6_Speed ;
 extern float a1_BegA   ;
 extern float a2_BegA   ;
 extern float a3_BegA   ;
 extern float a4_BegA   ;
 extern float a5_BegA   ;
 extern float a6_BegA   ;
 extern float a1_EndA  ;
 extern float a2_EndA  ;
 extern float a3_EndA  ;
 extern float a4_EndA  ;
 extern float a5_EndA  ;
 extern float a6_EndA  ;
 extern float a1_Coll ;
 extern float a2_Coll ;
 extern float a3_Coll ;
 extern float a4_Coll ;
 extern float a5_Coll ;
 extern float a6_Coll ;
 extern float a1_Rate;
 extern float a2_Rate;
 extern float a3_Rate;
 extern float a4_Rate;
 extern float a5_Rate;
 extern float a6_Rate;
 extern float a1_cTime ;
 extern float a2_cTime ;
 extern float a3_cTime ;
 extern float a4_cTime ;
 extern float a5_cTime ;
 extern float a6_cTime ;
 ...
 extern float iArm;
 extern float iArmMax;
 extern float iArmMin;
 extern float iArmGain;
 extern float shoesOut2;
 extern float shoesIn2;
 extern float rightShiftLow;
 extern float rightShiftHigh;
 extern float leftShiftLow;
 extern float leftShiftHigh;

 extern float A_ShotAngBeg;
 extern float A_ShotAngEnd ;
 extern float A_ShotSpeed  ;
 extern float B_ShotAngBeg;
 extern float B_ShotAngEnd ;
 extern float B_ShotSpeed  ;
 extern float X_ShotAngBeg;
 extern float X_ShotAngEnd ;
 extern float X_ShotSpeed  ;
 extern float Y_ShotAngBeg;
 extern float Y_ShotAngEnd ;
 extern float Y_ShotSpeed  ;
...
extern float crossHair1;
extern float crossHair2;
extern float crossHair3;
extern float crossHair4;
